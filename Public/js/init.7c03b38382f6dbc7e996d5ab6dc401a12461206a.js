...
(function (a, b) {
    ...
    function fc(a) {
        ...
        if (c === "none" || c === ""
            ...
            Lb = e.body.appendChild(Lb || q.extend(e.createElement("iframe"), {frameBorder: 0, width: 0, height: 0}));
    ...
    function lc(a, b, c, d) {
        ...
        }); else if (!c && q.type(b) === "object")for (e in b)lc(a + "[" + e + "]"
            , b[e], c, d); else d(a, b)
    }
    ...
    function Dc(a, c, d, e, f, g) {
        ...
        for (; k < l && (m || !i); k++) {
            i = j[k](c, d, e);
            if (typeof i == "string")if (!m || g[i])i = b; else {
    ...
    function Gc(a, b) {
        ...
        if (g[1])for (c in a.converters)j[c.toLowerCase()] = a.converters[c];
        for (; e = g[++k];)if (e !== "*") {
            if (i !== "*" && i !== e) {
                c =
                    j[i + " " + e] || j["* " + e];
    ...
    function Zc(a, b, c) {
        ...
        q.isFunction(k.opts.start) && k
            .opts.start.call(a, k);
        q.fx.timer(q.extend(j, {anim: k, queue: k.opts.queue, elem: a}));
    ...
    q.extend({
        ...
        , holdReady: function (a) {
            ...
            if (typeof d == "number")for (; f < d; f++)a[e++] = c
                [f]; else while (c[f] !== b)a[e++] = c[f++];
            a.length = e;
            return a
        }, grep: function (a, b, c) {
    ...
    q.ready.promise = function (b) {
        if (!d) {
            d = q.Deferred();
            if (e.readyState === "complete")setTimeout(q.ready, 1); else if (e.addEventListener) {
    ...
    q.support = function () {
        ...
        j.
            appendChild(o);
        if (o.attachEvent)for (l in{submit: !0, change: !0, focusin: !0}) {
            k = "on" + l;
            m = k in o;
            if (!m) {
    ...
    q.extend({
        ...
        removeData: function (a, b, c) {
            ...
            if (b) {
                d = c ? i[j] : i[j].data;
                if (d) {
                    if (!q.isArray(b))if (b in d)b = [b]; else {
                        b = q.camelCase(b);
    ...
    q.fn.extend({
        attr: function (a, b) {
            ...
            for (; c < d; c++)if (this[c].nodeType === 1 && (" " + this
                    [c].className + " ").replace(P, " ").indexOf(b) >= 0)return !0;
            return !1
        }, val: function (a) {
            var c, d, e, f = this[0];
            if (!arguments.length) {
        ...
        valHooks: {
            ...
            type: {
                set: function (a, b) {
                    ...
                    )q.error("type property can't be changed"); else if (!q.support.radioValue && b === "radio" && q.nodeName(a, "input")) {
                        var c = a.value;
    ...
    q.event = {
        ...
        dispatch: function (c) {
            ...
            if (r && (!c.button || c.type !== "click"))for (f = c.target; f != this; f = f.parentNode || this)if (f.disabled !== !0 || c.type !== "click") {
                ...
                k.length && v.push({elem: f, matches: k})
            }
            p.length > r && v.push({elem: this, matches: p.slice(r)});
        ...
        simulate: function (a, b, c, d) {
            var e = q.extend(new q.Event, c, {type: a, isSimulated: !0, originalEvent: {}});
    ...
    q
        ...
        }, isDefaultPrevented: db, isPropagationStopped: db, isImmediatePropagationStopped: db
    };
    q.each({
    ...
    q.fn.extend({
        on: function (a, c, d, e, f) {
            ...
            if (e === !1)e = db; else if (!e)return this;
            if (f === 1) {
                g = e;
                e = function (a) {
                    q().off(a);
    ...
    (function (a, b) {
        ...
        function pb(a) {
            ...
            for (; j < f; j++)if (c = e.relative[a[j].type])n = [lb(mb(n), c)]; else {
                c = e.filter[a[j].type].apply(null, a[j].matches);
                if (c[p]) {
                    d = ++j;
                    for (
                        ; d < f; d++)if (e.relative[a[d].type])break;
        ...
        e = fb.selectors = {
            cacheLength: 50, createPseudo: A, match: X, attrHandle: ab ? {} : {
                href: function (a) {
    ...
    q.fn.extend({
        text: function (a) {
            ...
            var c, d = 0;
            for (; (c = this[d]) != null; d++)if (!a || q.filter(a, [c]).length) {
                if (!b && c.nodeType === 1) {
                    q.cleanData(
    ...
    q.extend({
        clone: function (a, b, c) {
            ...
            if (q.support.html5Clone || q.isXMLDoc(a
                ) || !xb.test("<" + a.nodeName + ">"))g = a.cloneNode(!0); else {
            ...
            for (f = 0; (i = a[f]) != null
                ...
                typeof i == "number" && (i += "");
                if (!i)continue;
                if (typeof i == "string")if (!ub.test(i))i = b.createTextNode(i); else {
                    t = t || nb(b);
            ...
            )for (f = 0; (i = u[f]) != null; f++)q.nodeName(i, "input") ? Jb(i) : typeof i.getElementsByTagName != "undefined" && q.grep(i.getElementsByTagName("input"), Jb);
            if (c) {
                r = function (a) {
                    if (!a.type || Ab.test(a.type))return d ? d.push(a.parentNode ? a.parentNode.removeChild(a) : a) : c.appendChild
                    (a)
                };
                for (f = 0; (i = u[f]) != null; f++)if (!q.nodeName(i, "script") || !r(i)) {
                    c.appendChild(i);
            ...
            for (; (e = a[g]) != null; g++)if (b || q.acceptData(e)) {
                d = e[i];
                c = d && j[d];
                if (c) {
    ...
    r + ")(?!px)[a-z%]+$", "i"), Ub = new RegExp("^([-+])=(" + r + ")", "i"), Vb = {BODY: "block"}, Wb = {
        position: "absolute",
        visibility: "hidden",
        display: "block"
    }, Xb = {
    ...
    q.extend({
        ...
        }, cssProps: {"float": q.support.cssFloat ? "cssFloat" : "styleFloat"}, style: function (a, c, d, e) {
            ...
            return this
                .map(function () {
                    ...
                    return c == null ? null : q.isArray(c) ? q
                        .map(c, function (a, c) {
                            return {name: b.name, value: a.replace(ic, "\r\n")}
    ...
    q.each(["get", "post"], function (a, c) {
        q[c] = function (a, d, e, f) {
            ...
            return q.ajax({type: c, url: a, data: d, success: e, dataType: f})
        }
    });
    q.extend({
        getScript: function (a, c) {
        ...
        }, ajaxPrefilter: Cc(yc), ajaxTransport: Cc(zc), ajax: function (a, c) {
            function z(a, c, f, j) {
                var l, t, u, v, x, z = c;
                if (w === 2)return;
                w = 2;
            ...
            if (!m.beforeSend ||
                ...
                x = "abort";
                for (l in{success: 1, error: 1, complete: 1})y[l](m[l]);
                g = Dc(zc, m, c, y);
                if (!g)z(-1, "No Transport"); else {
                    y.readyState = 1;
        ...
        if (!c.crossDomain || q.support.cors) {
            ...
            return {
                send: function (e, f) {
                    ...
                    d = function (_, a) {
                        ...
                        try {
                            if (d && (a || j.readyState === 4)) {
                                ...
                                if (a)j.readyState !== 4 && j.abort(); else {
                                    e = j.status;
                    ...
                    if (!c.async)d(); else if (j.readyState === 4)setTimeout(
                        d, 0); else {
                        g = ++Nc;
                        if (Mc) {
                            if (!Lc) {
    ...
    q.Tween = ad;
    ad.prototype = {
        constructor: ad, init: function (a, b, c, d, e, f) {
            this.elem = a;
            this.prop = c;
            this.easing = e || "swing";
            this.options = b;
    ...
    q.fn.extend({
        fadeTo: function (a, b, c, d) {
            ...
            return this.each(function () {
                ...
                if (c)g[c] && g[c].stop && e(g[c]); else for (c in g)g[c] && g[c].stop && Uc.test(c) && e(g[c]);
                for (
    ...
    q.fn.offset = function (a) {
        ...
        var c, d, e, f, g, i, j, k = {top: 0, left: 0}, l = this[0], m = l && l.ownerDocument;
        if (!m)return;
        ...
        return {top: k.top + i - f, left: k.left + j - g}
    };
    q.offset = {
    ...
    q.each({scrollLeft: "pageXOffset", scrollTop: "pageYOffset"}, function (a, c) {
        var d = /Y/.test(c);
        q.fn[a] = function (e) {
    ...
    q.each({Height: "height", Width: "width"}, function (a, c) {
        q.each({
...
(function (a) {
    ...
    Array.prototype
        ...
        var f = 0, g;
        if (arguments
                .length >= 2)g = arguments[1]; else do {
            if (f in c) {
                g = c[f++];
                break
            }
    ...
    Array.prototype.reduceRight || (Array.prototype.reduceRight =
        function (b) {
            ...
            var f, g = d - 1;
            if (arguments.length >= 2)f = arguments
                [1]; else do {
                if (g in c) {
                    f = c[g--];
                    break
...
(function (a) {
    ...
    if (!Object.getOwnPropertyDescriptor) {
        ...
        Object.getOwnPropertyDescriptor = function (c, d) {
            ...
            if (!owns(c, d))return;
            var e = {enumerable: !0, configurable: !0};
...
(function (a, b) {
    ...
    function x() {
        var a = u(arguments), b = [];
        for (var c = 0
                 , d = a.length; c < d; c++)a[c].length > 0 && b.push(a[c].replace(/\/$/, ""));
        return b.join("/")
    }
    ...
    function E(a) {
        var b = [];
        for (var c = 0, d; d = a[c]; c++)d instanceof H ? b = b.concat(E(d.deps))
            : d instanceof B && b.push(d);
        return b
    }

    function F() {
        for (var a = 0, b; b = this.deps[a]; a++)if (b.forceFetch)b.forceFetch(); else {
            b.force = !0;
            b.start()
        }
        return this
    ...
    function Q(a) {
        function d(b, d) {
            c[d] = c[d] || {};
            c[d][a] = {
                key: a, start: b.startTime, end: b.endTime, duration: b.endTime - (b.startTime || (new Date
                ).getTime()), status: d, origin: b
            }
        }
    ...
    z.prototype.start =
        function () {
            ...
            if (b = o[this.key()])this.complete.apply(this, b.results); else if (c = p[this.key()])c.then(function () {
    ...
    I.prototype.get = function (a) {
        if (typeof this.entries[a] == "undefined")return null;
        for (var b = 0, c; c = this.entries[a][b]; b++)if (typeof c.startTime != "undefined")return c;
        return this
            .entries[a][0]
    };
    var O = function (a) {
...
loadrunner(function (a, b, c, d) {
    ...
    e.prototype.start = function () {
        if (e.loaded[this.path])this.complete(); else {
...
(function (a, b) {
    ...
    a.Template.prototype = {
        ...
        , v: m, t: l, render: function (b, c, d) {
            ...
            if (a === "." && n(b[b.length - 2]))i = b[b.length - 1]; else for (var l = 1; l < g.length; l++
            ) {
                f = c(g[l], i, j);
                if (f != null) {
                    k = i;
...
using.aliases = {
    ...
    "$bundle/events.24a95138a109d325d97c7b0fac82795741c7ef8a.js": ["app/ui/media/media_thumbnails", "app/ui/timelines/event_timeline", "app/data/page_visibility_scribe", "app/pages/events/hashtag"],
    "$bundle/accounts.b009d29cb5270896cb073ed6a4f722ee28430d42.js": ["app/ui/account/password_reset_controls", "app/ui/password_match_pair", "app/ui/with_password_strength", "app/ui/password_strength", "app/pages/account/password_reset", "app/ui/captcha_dialog", "app/ui/account/resend_password_controls", "app/ui/validating_fieldset", "app/data/resend_password", "app/pages/account/resend_password", "app/ui/account/verify_personal_information_controls", "app/pages/account/verify_personal_information", "app/ui/account/verify_device_token_controls", "app/pages/account/verify_device_token", "app/ui/account/resend_password_help_controls", "app/data/resend_password_help", "app/data/resend_password_help_scribe", "app/pages/account/resend_password_help", "app/pages/account/errors"],
    "$bundle/search.aab4fb07f5a55986054dddc9a89d2e30e084a00f.js": ["app/ui/dialogs/search_operators_dialog", "app/pages/search/home", "$lib/bootstrap_datepicker.js", "app/ui/with_bootstrap_datepicker", "app/ui/advanced_search", "app/pages/search/advanced"],
    "$bundle/vitonboarding.7086a7e16ad837f2d6b1df99b26cde1a0f571e15.js": ["$lib/jquery.hashchange.js", "app/ui/vit/verification_step", "app/ui/vit/mobile_topbar", "app/pages/vit/onboarding"],
    ...
    "$bundle/streams.3186a2e37963b1a7aed1dc4cdb2bc9fa69c53abd.js": ["app/data/streams/login_scribe", "app/ui/expanding_nav", "app/boot/streams", "app/ui/cookie_warning", "app/ui/signin_focus", "app/pages/streams/home", "app/pages/streams/stream"]
};
...
define("bower_components/flight/lib/debug", ["./registry"], function (a) {
    ...
    return {
        ...
        registry: a,
        find: {byName: e, byNameContains: f, byType: g, byValue: h, byValueCoerced: i, custom: j},
        events: {logFilter: l, logByAction: m, logByName: n, logAll: p, logNone: o}
    }
})
define("bower_components/flight/lib/utils", ["./debug"], function (a) {
    ...
    var b = 100, d = {
        isDomObj: function (a) {
            ...
            for (var e = b; e < c; e++)d[e - b] = a[e];
            return d
        }, merge: function () {
            var a = arguments.length, b = new Array(a + 1);
            if (a === 0)return {};
            for (var c = 0; c < a; c++)b[c + 1] = arguments[c];
            ...
            c() && a.hasOwnProperty(b) && Object.defineProperty(a, b, {writable: d})
...
define("bower_components/flight/lib/compose", ["./utils"], function (a) {
    ...
    function d(a, b) {
        ...
        for (var d = 0; d < b.length; d++)a.mixedIn.indexOf(b[d]) == -1 && (c(a, !1), b[d].call(a), a.mixedIn.push(b[d]));
        c(a, !0)
    }
...
define("bower_components/flight/lib/base", ["./utils", "./registry", "./debug"], function (a, b, c) {
    ...
    function g(a) {
        ...
        if (c.enabled && window.console) {
            for (var e in this.attrDef.prototype)b.push(e);
            d = Object.keys(a);
            for (var f = d.length - 1; f >= 0; f--)if (b.indexOf(d[f]) == -1) {
        ...
        for (var e in this.attrDef.prototype) {
            if (typeof a[e] == "undefined") {
                if (this.attr[e] === null)throw new Error('Required attribute "' + e + '" not specified in attachTo for component "' + this.toString() + '".')
    ...
    function h(a) {
        ...
        for (var c in this.defaults)a.hasOwnProperty(c) || (b[c] = this.defaults[c]);
        this.attr = b
    }
        ...
        this.trigger = function () {
            ...
            if (d) {
                ...
                f && f.some(function (a, b, c) {
                    if (a.context && this.identity == a.context.identity)return c.splice(b, 1), d = a, !0
                }, this), a.off(c, d)
            } else b.findInstanceInfo(this).events.forEach(function (b) {
...
define("bower_components/flight/lib/component", ["./advice", "./utils", "./compose", "./base", "./registry", "./logger", "./debug"], function (a, b, c, d, e, f, g) {
    ...
    function l() {
        ...
        for (var n = 0; n < h; n++)m[n] = arguments[n];
        var o = function () {
        };
    ...
    function withInteractionDataScribe() {
        this.defaultAttrs({
            ...
            if (this.isUserTarget(b.action, b.component)) {
                ...
                return this.userDetails({}, {userId: c})
            }
        }, this.tweetDetails = function (a, b) {
            return a.id = b.tweetId, a.item_type = itemTypes.tweet, a.media_details || (a.media_details = {}), a.media_details.photo_count = b.photoCount, b.relevanceType && (a.is_popular_tweet = !0), b.retweetId && (a.retweeting_tweet_id = b.retweetId), a
            ...
            var c = {page: a.page, section: a.section};
...
define("app/data/with_card_metadata", ["module", "require", "exports", "core/compose", "core/utils", "app/utils/scribe_association_types", "app/data/with_interaction_data_scribe", "app/utils/scribe_item_types", "app/utils/scribe_card_types"], function (module, require, exports) {
    function withCardMetadata() {
        ...
        this.cardAssociationsForData = function (a) {
        ...
        }, this.scribeClassicCardInteraction = function (a, c) {
            var d = this.cardAssociationsForData(c), e = c.cardType ? "platform_" + c.cardType + "_card" : b;
            this.scribeInteraction({element: e, action: a}, c, d)
            ...
            typeof e == "object" && e && (f = utils.merge(f, e)), g = {items: [f]}, this.scribeInteraction({
                element: d || b,
                action: a
            }, c, g)
...
define("app/data/with_conversation_metadata", ["module", "require", "exports"], function (module, require, exports) {
    module.exports = function () {
        this.defaultAttrs({
            ...
            return {itemType: "tweet", tweetId: $(a).attr("data-item-id"), description: b, isConversationComponent: !0}
...
define("app/ui/with_interaction_data", ["module", "require", "exports", "core/compose", "core/utils", "app/data/with_card_metadata", "app/data/with_conversation_metadata"], function (module, require, exports) {
    function withInteractionData() {
        ...
        }, a), c = utils.merge({activityType: "data-activity-type"}, b), d = utils.merge({
            storyType: "data-story-type",
            storySource: "data-source"
        }, b), e = {contactId: "data-item-id", importClientApplicationId: "data-client-application-id"};
        this.interactionDataWithCard = function (a, b) {
            ...
            return utils.merge({scribeContext: d, scribeData: e}, h)
            ...
            return b.tweetHasCard2 ? {cardItem: this.getCard2Item(b)} : {}
        }
    }
...
define("app/data/tweet_actions_scribe", ["module", "require", "exports", "core/component", "core/utils", "app/ui/with_interaction_data", "app/data/with_conversation_metadata", "app/data/with_interaction_data_scribe"], function (module, require, exports) {
    function tweetActionsScribe() {
        this.defaultAttrs({tweetActionsSelector: ".ProfileTweet-action--more"}), this.scribeTweet = function (a) {
            return function (b, c) {
                var d = this.addConversationScribeContext({action: a}, c.sourceEventData || c);
...
define("app/data/block_or_report_scribe", ["module", "require", "exports", "core/component", "core/utils", "app/utils/scribe_item_types", "app/utils/scribe_association_types", "app/data/with_interaction_data_scribe"], function (module, require, exports) {
    function blockOrReportScribe() {
        this.getComponent = function (a) {
            ...
            this.scribeBlockOrReportEvent({component: this.getComponent(b), action: "impression"}, b)
        }, this.cancelBlockOrReport = function (a, b) {
            this.scribeBlockOrReportEvent({component: this.getComponent(b), action: "cancel"}, b)
            ...
            var c = {component: this.getComponent(b.eventData) + "_abusive", element: b.abuseType, action: "click"};
            ...
            }, this.scribeInteraction(a, b, {associations: c})
            ...
            var a = {component: this.getComponent(b.eventData), element: "twitter_rules_link", action: "open_link"};
...
define("app/data/report_dialog_scribe", ["module", "require", "exports", "core/component", "core/utils", "app/utils/scribe_item_types", "app/utils/scribe_association_types", "app/data/with_interaction_data_scribe"], function (module, require, exports) {
    function reportScribe() {
        this.getComponent = function (a) {
            return a.target === "user" ? "report_user" : "report_tweet"
        }, this.reportImpression = function (a, b) {
            this.scribeReportEvent({component: this.getComponent(b), action: "impression"}, b)
        }, this.cancelReport = function (a, b) {
            this.scribeReportEvent({component: this.getComponent(b), action: "cancel"}, b)
        }, this.reportSubmit = function (a, b) {
            var c = b.reportType || "", d = {
                component: this.getComponent(b.eventData),
                action: "report_as_spam",
                element: c
            };
            this.scribeReportEvent(d, b)
        }, this.reportAbuseToSupport = function (a, b) {
            var c = {component: this.getComponent(b.eventData) + "_abusive", element: b.abuseType, action: "click"};
            this.scribeReportEvent(c, b)
        }, this.scribeReportEvent = function (a, b) {
            var c = b.eventData || b;
            c.target === "user" ? this.scribeReportUserEvent(a, b) : this.scribeReportTweetEvent(a, c)
        }, this.scribeReportTweetEvent = function (a, b) {
            var c = {};
            ...
            var a = {component: this.getComponent(b.eventData), element: "twitter_rules_link", action: "open_link"};
            this.scribeReportEvent(a, b)
        }, this.after("initialize", function () {
            this.on(document, "uiNeedsReportDialog", this.reportImpression), this.on(document, "uiDidReportTweet uiReportUserAction", this.reportSubmit), this.on(document, "uiDidReportToSupport", this.reportAbuseToSupport), this.on(document, "uiDidCancelReport", this.cancelReport), this.on(document, "uiDidOpenTwitterRulesLink", this.openTwitterRulesLink)
        })
    }
...
define("app/data/block_dialog_scribe", ["module", "require", "exports", "core/component", "app/data/with_interaction_data_scribe", "core/utils"], function (module, require, exports) {
    function blockDialogScribe() {
        this.defaultAttrs({scribeContext: {component: "block_dialog"}}), this.getScribeElement = function (a) {
            return a.target === "user" ? "user" : "tweet"
        }, this.scribeBlockDialogImpression = function (a, b) {
            var c = {
                element: this.getScribeElement(b),
                action: "impression"
            }, d = utils.merge(this.attr.scribeContext, c);
            this.scribeInteraction(d, b)
        }, this.scribeBlockDialogCancel = function (a, b) {
            var c = {element: this.getScribeElement(b), action: "cancel"}, d = utils.merge(this.attr.scribeContext, c);
            this.scribeInteraction(d, b)
        }, this.after("initialize", function () {
            this.on("uiNeedsBlockDialog", this.scribeBlockDialogImpression), this.on("uiBlockDialogCancel", this.scribeBlockDialogCancel)
        })
    }

    var defineComponent = require("core/component"), withInteractionDataScribe = require("app/data/with_interaction_data_scribe"), utils = require("core/utils");
    module.exports = defineComponent(blockDialogScribe, withInteractionDataScribe)
});
    ...
    function userActionsScribe() {
        ...
        this.defaultAttrs({
            ...
            userActionToActionMap: {
                ...
                uiRetweetOnAction: {element: "allow_retweets", action: "on"},
                uiRetweetOffAction: {element: "allow_retweets", action: "off"},
                uiDeviceNotificationsOnAction: {element: "mobile_notifications", action: "on"},
                uiDeviceNotificationsOffAction: {element: "mobile_notifications", action: "off"},
                uiShowMobileNotificationsConfirm: {element: "mobile_notifications", action: "failure"},
                uiShowPushTweetsNotificationsConfirm: {element: "mobile_notifications", action: "failure"},
                uiUserTopicClickAction: {element: "topic", action: "click"},
...
define("app/data/item_actions_scribe", ["module", "require", "exports", "core/component", "app/data/with_interaction_data_scribe", "app/data/with_conversation_metadata", "app/data/with_card_metadata"], function (module, require, exports) {
    function itemActionsScribe() {
        this.defaultAttrs({profileHoversEnabled: !1}), this.handleNewerTimelineItems = function (a, b) {
            this.scribeInteractiveResults({element: "newer", action: "results"}, b.items, b)
        }, this.handleRangeTimelineItems = function (a, b) {
            this.scribeInteractiveResults({element: "range", action: "results"}, b.items, b)
        }, this.handlePeriodPress = function (a, b) {
            this.scribe({element: "period_press", action: "results"})
        }, this.handleTopBarBirdClick = function (a, b) {
            this.scribe({component: "top_bar", element: "bird", action: "results"})
        }, this.handleUserComposedTweet = function (a, b) {
            this.scribe({element: "composed_tweet", action: "results"})
        }, this.handleUserFollowTweetInjection = function (a, b) {
            this.scribe({element: "follow_tweet_injection", action: "results"})
        }, this.handleStreamingInjection = function () {
            this.scribe({element: "streaming_injection", action: "results"})
        }, this.handlePushStateInjection = function (a, b) {
            this.scribe({element: "pushstate_injection", action: "results"})
        }, this.handleProfilePopup = function (a, b) {
            var c = b.sourceEventData, d = c.isMentionClick ? "mention_click" : "profile_click";
            c.userId = b.user_id;
            if (c.interactionInsideCard)this.scribeCardAction(d, a, c); else {
                var e = this.addConversationScribeContext({action: d}, c, !0);
                this.scribeInteraction(e, c)
            }
        }, this.scribeItemAction = function (a, b, c) {
            var d = this.addConversationScribeContext({action: a}, c);
            this.scribeInteraction(d, c)
        }, this.scribeSearchTagClick = function (a, b) {
            var c = a.type == "uiCashtagClick" ? "cashtag" : "hashtag";
            this.scribeInteraction({element: c, action: "search"}, b)
        }, this.scribeGeoPivotClick = function (a, b) {
            var c = {context: b.placeId, event_value: b.tweetId};
            this.scribeInteraction({element: "place_pivot", action: "click"}, b, c)
...
define("app/boot/scribing", ["module", "require", "exports", "app/data/scribe_transport", "app/data/scribe_monitor", "app/data/client_event", "app/data/tweet_actions_scribe", "app/data/block_or_report_scribe", "app/data/report_dialog_scribe", "app/data/block_dialog_scribe", "app/data/user_actions_scribe", "app/data/item_actions_scribe", "app/data/navigation_scribe", "app/data/update_scribe", "app/utils/cookie"], function (module, require, exports) {
    function initialize(a) {
        ...
        }, delete clientEvent.internalReferer, a.loggedIn || (clientEvent.scribeData.user_id = 0), (a.environment != "production" || a.preflight || a.scribesForScribeConsole) && ScribeMonitor.attachTo(document, {scribesForScribeConsole: a.scribesForScribeConsole}), TweetActionsScribe.attachTo(document, a), BlockOrReportScribe.attachTo(document, a), ReportDialogScribe.attachTo(document, a), BlockDialogScribe.attachTo(document, a), UserActionsScribe.attachTo(document, a), ItemActionsScribe.attachTo(document, a), NavigationScribe.attachTo(document, a), UpdateScribe.attachTo(document)
    }
...
define("app/ui/navigation", ["module", "require", "exports", "core/component", "app/utils/full_path", "app/utils/push_state_enabled"], function (module, require, exports) {
    function navigation() {
        this.defaultAttrs({
            ...
            var c = {state: a.originalEvent && a.originalEvent.state};
            this.trigger(document, {type: "uiPopStateNavigate", defaultBehavior: this.doPopState.bind(this, a, c)}, c)
...
define("app/data/notifications", ["module", "require", "exports", "app/utils/storage/core", "app/utils/time"], function (module, require, exports) {
    ...
    Notification.prototype = {
        ...
        init: function (a) {
            this.initialized = !0, this.dm = new Notification(a.toasts_dm, "d", "uiDMPoll", this.addDMData), this.connect = new Notification(a.toasts_timeline, "t", null, function () {
            }), this.spoonbill = new Notification(a.toasts_spoonbill, "n", null, this.addSpoonbillData), this.spoonbill.shouldPoll = function () {
                return !0
...
define("app/utils/params", ["module", "require", "exports", "app/utils/querystring"], function (module, require, exports) {
    ...
    module.exports = {combined: combined, fromQuery: fromQuery, fromFragment: fromFragment}
});
define("app/data/with_auth_token", ["module", "require", "exports", "app/utils/auth_token", "core/utils"], function (module, require, exports) {
    function withAuthToken() {
        this.addAuthToken = function (b) {
            ...
            return b = b || {}, utils.merge(b, {authenticity_token: authToken.get()})
        }, this.addPHXAuthToken = function (b) {
            if (!authToken.get())throw"addPHXAuthToken requires a formAuthenticityToken";
            return b = b || {}, utils.merge(b, {post_authenticity_token: authToken.get()})
...
define("app/data/profile_info", ["module", "require", "exports"], function (module, require, exports) {
    var cache = {}, profileInfo = {
        set: function (a) {
            ...
            this.set({profile_presentation: null})
        }, info: cache
    };
    profileInfo.reset(), module.exports = profileInfo
});
define("app/data/with_data", ["module", "require", "exports", "core/compose", "core/i18n", "core/utils", "app/data/notifications", "app/utils/params", "app/utils/time", "app/data/with_auth_token", "app/utils/storage/custom", "app/utils/storage/core", "app/data/profile_info"], function (module, require, exports) {
        ...
        this.defaultAttrs({}), this.composeData = function (a, b) {
            ...
            return initializeXhrStorage(), function (e, f, g) {
                ...
                if (e && e.hasOwnProperty("note") && e.hasOwnProperty("inner")) {
                    c.returnNotificationData || (i = e.inner), j = e.note;
            ...
            b.push(e)
        }, this.handleBouncer = function (a) {
            if (a && a.errors) {
                var b = a.errors.length;
                for (var c = 0; c < b; c++) {
                    var d = a.errors[c];
                    if (d && d.code == 326) {
                        var e = d.bounce_location || "/account/access";
                        return e.indexOf("https://") === 0 ? this.redirect(e) : (e.charAt(0) !== "/" && (e = "/" + e), this.redirect("https://twitter.com" + e)), !0
                    }
                }
            }
            return !1
            ...
            return function (g, h) {
                ...
                var j;
                try {
                    j = JSON.parse(g.responseText);
                    if (this.handleBouncer(j))return;
                    j && j.challengeName ? this.trigger(document, "dataInitialChallengeNeeded", j) : j && j.message && !this.attr.noShowError && this.trigger("uiShowError", j)
                } catch (k) {
                    j = {xhr: {}}, g && g.statusText && (j.xhr.statusText = g.statusText)
                }
                j.message || (j.message = _('\u5185\u90e8\u670d\u52a1\u5668\u9519\u8bef\u3002')), j = this.composeData(j, c), b && this.callErrorHandler(b, j, c)
            }.bind(this)
            ...
            return function (d, e, f) {
                ...
                this.trigger && this.attr.statsName && this.trigger("dataAjaxDuration", {
                    ...
                    statsSubcategory: a.statsSubcategory,
                    duration: g,
                    status: e,
                    url: a.url,
            ...
            ["GET", "POST"].indexOf(c) < 0 && (i = $.extend({_method: c}, i), c = "POST"), c == "POST" && (i = this.addAuthToken(i), j && j["X-PHX"] && (i = this.addPHXAuthToken(i)));
            var k = $.extend({lang: !0}, b.echoParams);
            ...
            b.success = this.createSuccessHandler(b.success, b, l), b.error = this.createErrorHandler(b.error, b, f, g, l), Profile.info && Profile.info.presentation && $.extend(b.headers, {"X-PROF": Profile.info.presentation}), this.attr.includePageContext && this.attr.pageContext && (i.page_context = this.attr.pageContext);
            var m = $.ajax($.extend(b, {url: b.url, data: this.sortData(i), dataType: b.dataType || "json", type: c}));
            return b.noAbortOnNavigate || a.push(m), m
        }, this.get = function (a) {
    ...
    var compose = require("core/compose"), _ = require("core/i18n"), utils = require("core/utils"), notifications = require("app/data/notifications"), params = require("app/utils/params"), time = require("app/utils/time"), withAuthToken = require("app/data/with_auth_token"), customStorage = require("app/utils/storage/custom"), CoreStorage = require("app/utils/storage/core"), Profile = require("app/data/profile_info"), StorageConstr = customStorage({withExpiry: !0}), storage, xhrStorage;
...
define("app/data/navigation", ["module", "require", "exports", "core/component", "core/utils", "core/registry", "app/utils/time", "app/utils/full_path", "app/data/with_data", "app/data/with_rollback_count", "app/utils/push_state_enabled"], function (module, require, exports) {
    function navigationData() {
        this.defaultAttrs({
            ...
            pushState: !0,
            pushStateRequestHeaders: {"X-Push-State-Request": !0},
        ...
        this.pageCache = {}, this.pageCacheTTLs = {}, this.navigateUsingPushState = function (a, b) {
            ...
            if (b = this.pageCache[a])b.fromCache = !0, b.href = a, this.pageDataReceived(a, b); else {
                this.trigger("dataPageFetch");
                var c = this.attr.pushStateRequestHeaders;
                this.attr.init_data.isMonorail && (c = utils.merge(c, {"X-Referrer-Stack": "monorail"})), c = utils.merge(c, {"X-Asset-Version": this.attr.init_data.assetVersionKey}), this.get({
                    headers: c,
                    url: a,
                    success: function (b) {
                        var c;
            ...
            this.rollbackCount() > 0 ? (e = utils.once(this.refreshPage.bind(this, a, b)), this.on("uiDidRollback", e), this.trigger("dataNeedsRollback", {rollbackCount: this.rollbackCount()})) : (e && (this.off("uiDidRollback", e), e = null), this.refreshPage(a, b))
        }, this.refreshPage = function (a, b) {
            a != fullPath() && history.pushState({title: b.title}, b.title, a), b.isPopState = c, setTimeout(function () {
            ...
            if (this.attr.init_data.initialState) {
                ...
                history.replaceState({title: c}, c, fullPath())
            }
...
define("app/data/teardown_manager", ["module", "require", "exports", "core/component", "core/registry"], function (module, require, exports) {
    function TeardownManager() {
        this.defaultAttrs({noTeardown: !0}), this.doTeardown = function (a, b) {
...
define("app/utils/prevent_next_tooltip", ["module", "require", "exports"], function (module, require, exports) {
    function preventNextTooltip(a) {
        var b = $(a);
        if (!b.hasClass("js-tooltip"))return;
...
deferred('$lib/bootstrap_tooltip.js', function () {
    ...
    !function ($) {
        ...
        f.prototype = {
            constructor: f, init: function (a, b, c) {
                ...
                if (this.shouldShow() && this.hasContent() && this.enabled) {
                    ...
                    switch (c ? g.split(" ")[1] : g) {
                        case"bottom":
                            h = {top: d.top + d.height, left: d.left + d.width / 2 - e / 2};
                            break;
                        case"top":
                            h = {top: d.top - f, left: d.left + d.width / 2 - e / 2};
                            break;
                        case"left":
                            h = {top: d.top + d.height / 2 - f / 2, left: d.left - e};
                            break;
                        case"right":
                            h = {top: d.top + d.height / 2 - f / 2, left: d.left + d.width}
                    }
                ...
                return b.is("a") && b.find(c).length && (b = b.find(c)), $.extend({}, a ? {
                    top: 0,
                    left: 0
                } : b.offset(), {width: b[0].offsetWidth, height: b[0].offsetHeight})
            }, tip: function () {
...
define("app/ui/with_dropdown", ["module", "require", "exports", "core/compose", "app/utils/with_keyboard_modality", "app/utils/prevent_next_tooltip", "$lib/bootstrap_tooltip.js"], function (module, require, exports) {
    function withDropdown() {
        compose.mixin(this, [withKeyboardModality]), this.defaultAttrs({
            ...
            a.prop("nodeName") == "A" && a.attr({role: "button"}), a.attr({"aria-haspopup": !0})
            ...
            this.on(document, "uiSwiftLoaded", this.applyARIAAttrs), this.on("uiShouldShowDropdown", this.showDropdown), this.on("click", {togglerSelector: this.toggleDisplay}), this.on(document, "uiCloseDropdowns", this.notifyCloseRequested), this.on(document, "click", this.close), this.on(document, "uiShortcutEsc", this.closeAndRestoreFocus), this.on(document, "uiBeforePageChanged uiPageChanged uiNavigate uiForceDropdownClosed", this.closeDropdown)
        })
    }
...
define("app/ui/with_dropdownmenu", ["module", "require", "exports", "core/compose", "app/ui/with_dropdown", "app/utils/is_visible", "app/utils/is_enabled"], function (module, require, exports) {
    function withDropdownMenu() {
        compose.mixin(this, [withDropdown]), this.defaultAttrs({
            ...
            if (!this.isOpen())return;
            var b = {38: "prev", 40: "next"}[a.keyCode];
            if (!b)return;
            ...
            this.on(document, "keydown", {menuListSelector: this.moveSelection}), this.on(document, "click", {menuitemFragmentSelector: this.preventFragmentNavigation}), this.on(document, "uiDropdownOpened", this.applyARIAAndFocus), this.on(document, "uiDropdownClosed", this.toggleARIAHiddenState)
        })
    }
...
define("app/data/user_info", ["module", "require", "exports"], function (module, require, exports) {
    var user = {}, userInfo = {
        set: function (a) {
            ...
            this.set({screenName: null, fullName: null, deciders: {}, experiments: {}})
        }, user: user, getDecider: function (a) {
...
define("app/ui/macaw_nymizer", ["module", "require", "exports", "core/component", "app/data/user_info", "app/utils/params"], function (module, require, exports) {
    function macawNymizer() {
        this.defaultAttrs({kenshooLandingParam: "ken_prf", checkLandingParam: !0}), this.hitEndpoint = function (a) {
            var b = new Image;
            ...
            this.hitEndpoint([{integration: "kenshooClick", ref: document.referrer, type: "click"}])
        }, this.conversion = function (a, b) {
            this.hitEndpoint([{integration: "kenshooConversion", ref: document.referrer, type: b.mnType}])
        }, this.after("initialize", function () {
    ...
    function impressionCookies() {
        this.defaultAttrs({
            ...
            if (this.linkIsLocalAndWihoutAHashBang(b.hostName, b.href) && b.impressionCookie) {
                this.trigger("uiPromotedLinkClick", {href: b.href});
                var c = new Date, d = 6e4, e = new Date(c.getTime() + d);
                this.setCookie(b.impressionCookie, e)
            }
        }, this.after("initialize", function () {
            this.on("click", {sendImpressionCookieSelector: this.sendImpressionCookie}), this.on("uiShowProfileNewWindow", {link: this.sendImpressionCookie}), this.on("uiSendImpressionCookie", this.triggerPromotedClickAndSetCookie)
        })
    }
...
define("app/data/promoted_logger", ["module", "require", "exports", "core/component", "app/data/with_data", "app/data/user_info"], function (module, require, exports) {
    function promotedLogger() {
        this.defaultAttrs({
            ...
            if (!b)return;
            this.logEvent({event: "url_click", impression_id: b, earned: this.isEarnedMedia(c), url: d}, !0)
            ...
            if (!b)return;
            this.logEvent({event: "user_mention_click", impression_id: b, earned: this.isEarnedMedia(c)}, !0)
        }, this.logPromotedTweetHashtagClick = function (a) {
            var b = $(a.target).closest("[data-impression-id]").attr("data-impression-id"), c = $(a.target).closest("[data-impression-id]").attr("data-disclosure-type");
            if (!b)return;
            this.logEvent({event: "hashtag_click", impression_id: b, earned: this.isEarnedMedia(c)}, !0)
            ...
            this.logEvent({event: "email_tweet", impression_id: c, earned: d})
            ...
            b.profileClickTarget === "avatar" ? this.logEvent({
                ...
                impression_id: c,
                earned: d
            }) : this.logEvent({event: "screen_name_click", impression_id: c, earned: d})
            ...
            if (!c)return;
            this.logEvent({event: "dismiss", impression_id: c, earned: this.isEarnedMedia(d)})
            ...
            if (!c || e || f)return;
            this.logEvent({event: "view_details", impression_id: c, earned: this.isEarnedMedia(d)})
        }, this.logPromotedTweetCardUrlClick = function (a, b) {
            var c = b.impressionId, d = b.disclosureType, e = b.cardEvent;
            if (c) {
                var f = {event: "card_url_click", impression_id: c, earned: this.isEarnedMedia(d)};
                e ? (f.card_event = e, this.logEvent(f, !1, !0)) : this.logEvent(f)
            }
        }, this.logPromotedTweetEmbeddedMedia = function (a, b) {
            var c = b.impressionId, d = b.disclosureType;
            c && this.logEvent({event: "embedded_media", impression_id: c, earned: this.isEarnedMedia(d)})
        }, this.logPromotedVideoEvent = function (a, b) {
            if (!userInfo.getDecider("promoted_video_logging_enabled"))return;
            var c = b.impressionId, d = b.disclosureType;
            if (c) {
                var e = {event: b.name, impression_id: c, earned: this.isEarnedMedia(d), playlist_url: b.playlist_url};
            ...
            var c = b.impressionId, d = b.disclosureType;
            if (!c)return;
            this.logEvent({event: "buynow_card_click", impression_id: c, earned: this.isEarnedMedia(d)})
        }, this.logPromotedBuyNowPurchaseSuccessEvent = function (a, b) {
            var c = b.impressionId, d = b.disclosureType;
            if (!c)return;
            this.logEvent({event: "buynow_purchase_success", impression_id: c, earned: this.isEarnedMedia(d)})
        }, this.after("initialize", function () {
...
define("app/ui/message_drawer", ["module", "require", "exports", "core/component"], function (module, require, exports) {
    function messageDrawer() {
        this.defaultAttrs({
            ...
            this.showing = !0;
            var d = {top: this.attr.topOffset + $(this.attr.bannersSelector).height()};
            ...
            this.showing = !1, a && a.preventDefault(), this.$node.animate({top: -40}, 300, function () {
                this.setHidden()
            }.bind(this))
            ...
            a.type === "uiDialogOpened" ? this.$node.stop().css({top: 0}) : this.dialogPresent() || this.$node.queue(function (a) {
                this.$node.css({top: this.attr.topOffset + $(this.attr.bannersSelector).height()}), a()
            }.bind(this))
        }, this.after("initialize", function () {
            ...
            }), this.on(document, "uiBeforePageChanged uiHideMessage", this.setHidden), this.on("mouseenter", {messageSelector: this.handleMouseEnter}), this.on("mouseleave", {messageSelector: this.handleMouseLeave}), this.on(document, "uiDialogOpened uiDialogClosed", this.repositionMessage), this.$node.hasClass(this.attr.hiddenClass) && this.closeMessage()
        })
    }
...
define("app/ui/tooltips", ["module", "require", "exports", "core/component", "$lib/bootstrap_tooltip.js"], function (module, require, exports) {
    function tooltips() {
        this.defaultAttrs({
            ...
            this.$node.tooltip({selector: this.attr.tooltipSelector}), this.on(document, "uiShortcutEsc", {
...
define("app/ui/forms/screen_reader_label", ["module", "require", "exports", "core/component"], function (module, require, exports) {
    function screenReaderLabel() {
        this.defaultAttrs({inputSelector: "input[placeholder],textarea[placeholder]"}), this.addLabels = function () {
    ...
    function ttftNavigate() {
        this.beforeNewPageLoad = function (a, b) {
            this.log("beforeNewPageLoad", a, b), time = {
                ...
                source: {page: this.attr.pageName, action: this.attr.sectionName, path: window.location.pathname}
            }
...
define("app/ui/banners/eu_cookie", ["module", "require", "exports", "core/component", "app/utils/cookie"], function (module, require, exports) {
    function euCookie() {
        this.defaultAttrs({closeButtonSelector: ".eu-cookie-notice button"}), this.setCookie = function () {
            cookie("eu_cn", 1, {expires: 365})
        }, this.close = function () {
            this.setCookie(), this.$node.remove(), this.teardown()
        }, this.after("initialize", function () {
            this.on("click", {closeButtonSelector: this.close}), setTimeout(function () {
                this.setCookie()
            }.bind(this), 5e3)
        })
    }
...
define("app/ui/keyboard_shortcuts", ["module", "require", "exports", "core/component", "core/utils"], function (module, require, exports) {
    function keyBoardShortcuts() {
        this.keyCodeToEvent = {
            27: {type: "uiShortcutEsc", defaultFn: "blurTextField"},
            13: "uiShortcutEnter",
            37: "uiShortcutLeft",
            39: "uiShortcutRight"
        }, this.metaKeyCodeToEvent = {13: "uiShortcutCmdEnter"}, this.charsToEvent = {
            ...
            "/": {type: "uiShortcutGotoSearch", defaultFn: "focusSearch"},
            m: "uiOpenNewDM",
            ...
            gs: "settings",
            gl: "lists"
        }, this.lastKey = "", this.defaultAttrs({globalSearchBoxSelector: "#search-query"}), this.shortcutFromKeyCode = function (a, b) {
            ...
            if (this.isMetaKey(a) || this.isTextField(a.target))return;
    ...
    var defineComponent = require("core/component"), utils = require("core/utils"), whiteListedElements = {
        button: !0,
        a: !0
    }, whiteListedInputs = {button: !0, submit: !0, file: !0}, textInputs = {
        password: !0,
        text: !0,
        email: !0
...
define("app/ui/aria_event_logger", ["module", "require", "exports", "core/component", "core/i18n", "core/utils"], function (module, require, exports) {
    function ariaEventLogger() {
        this.defaultAttrs({typeaheadDebounceInterval: 500}), this.MESSAGES = {
            FAVORITED: _('\u5df2\u6536\u85cf'),
            UNFAVORITED: _('\u5df2\u53d6\u6d88\u6536\u85cf'),
            RETWEETED: _('\u5df2\u8f6c\u63a8'),
            UNRETWEETED: _('\u5df2\u64a4\u9500\u8f6c\u63a8'),
            EXPANDED: _('\u5df2\u5c55\u5f00'),
            COLLAPSED: _('\u5df2\u6536\u8d77'),
            RENDERING_CONVERSATION: _('\u6b63\u5728\u8f7d\u5165\u5bf9\u8bdd\u3002'),
            CONVERSATION_RENDERED: _('\u5bf9\u8bdd\u5df2\u8f7d\u5165\u3002\u6309\u4e0b j \u6216 k \u952e\u4ee5\u67e5\u770b\u63a8\u6587\u3002'),
            CONVERSATION_START: _('\u5bf9\u8bdd\u5f00\u59cb\u3002'),
            CONVERSATION_END: _('\u5bf9\u8bdd\u7ed3\u675f\u3002'),
            NEW_ITEMS_BAR_VISIBLE: _('\u6709\u65b0\u7684\u63a8\u6587\uff0c\u6309 . \u4ee5\u67e5\u770b\u5b83\u4eec\u3002')
            ...
            b.numResults > 1 ? this.logMessage(_('{{numResults}}\u4e2a\u63a8\u8350\u3002', {numResults: b.numResults}), "polite") : this.logMessage(_('{{numResults}}\u4e2a\u63a8\u8350\u3002', {numResults: b.numResults}), "polite")
...
define("app/ui/mute_user", ["module", "require", "exports", "core/component", "app/data/with_interaction_data_scribe"], function (module, require, exports) {
    function muteUser() {
        this.defaultAttrs({
            ...
            this.scribeInteraction({component: "message_drawer", element: "learn_more_link", action: "open_link"}, b, c)
        }, this.doAction = function (a, b, c) {
            if (b.itemType == "tweet")return;
            ...
            return function (b, c) {
                ...
                if (e) {
                    ...
                    if (d.closest("#profile_popup")[0])c.scribeContext.component = "profile_dialog"; else if (d.closest(".profile-page-header")[0] || d.closest(".ProfileNav-item--userActions"))c.scribeContext.component = "profile_follow_card"
                } else e = d.closest(".tweet")[0] || d.closest(".ProfileTweet")[0], c.scribeContext.component = "tweet", c.scribeContext.element = "tweet_actions_dropdown";
...
define("app/data/mute_user", ["module", "require", "exports", "core/component", "app/data/with_data"], function (module, require, exports) {
    function muteUser() {
        this.defaultAttrs({
            successFromEndpoints: {mute: "dataDidMuteUser", unmute: "dataDidUnmuteUser"},
            errorsFromEndpoints: {mute: "dataFailedToMuteUser", unmute: "dataFailedToUnmuteUser"}
        }), this.takeAction = function (a, b, c) {
            var d = function (b) {
                b = $.extend(b, {userId: c.userId}), b && b.message && this.trigger("uiShowMessage", b), this.trigger(this.attr.successFromEndpoints[a], b)
            }, e = function (b) {
...
define("app/ui/undo_unblock", ["module", "require", "exports", "core/component", "app/data/with_interaction_data_scribe"], function (module, require, exports) {
    function undoUnblockUser() {
        this.defaultAttrs({undoUnblockSelector: ".js-undo-unblock"}), this.handleUndo = function (a, b) {
            b.userId = $(b.el).data("user-id"), b.screenName = $(b.el).data("screen-name");
            var c = {component: "message_drawer", element: "undolink"};
            this.trigger("uiBlockAction", {userId: b.userId, scribeContext: c})
        }, this.after("initialize", function () {
            this.on("click", {undoUnblockSelector: this.handleUndo})
        })
    }
...
deferred('$bower_components/jquery-placeholder/jquery.placeholder.js', function () {
    ...
    (function (a, b, $) {
            ...
            if (!a && d.value == "" || e.hasClass("placeholder")) {
                if (d.type == "password") {
                    if (!e.data("placeholder-textinput")) {
                        try {
                            c = e.clone().attr({type: "text"})
                        } catch (a) {
                            c = $("<input>").attr($.extend(j(this), {type: "text"}))
                        }
                        c.removeAttr("name").data({
                            "placeholder-password": !0,
                            "placeholder-id": g
                        }).bind(i), e.data({"placeholder-textinput": c, "placeholder-id": g}).before(c)
                    }
        ...
        function n(a) {
            ...
            var b = {35: !0, 36: !0, 37: !0, 38: !0, 39: !0, 40: !0};
...
define("app/boot/common", ["module", "require", "exports", "app/utils/auth_token", "app/boot/scribing", "app/ui/navigation", "app/data/navigation", "app/data/teardown_manager", "app/ui/language_dropdown", "app/ui/google", "app/ui/macaw_nymizer", "app/ui/impression_cookies", "app/data/promoted_logger", "app/ui/message_drawer", "app/ui/tooltips", "app/ui/forms/screen_reader_label", "app/data/ttft_navigation", "app/utils/cookie", "app/utils/querystring", "app/data/user_info", "app/ui/banners/eu_cookie", "app/ui/keyboard_shortcuts", "app/ui/dynamic_image_loader", "app/ui/aria_event_logger", "app/data/scriber", "app/ui/mute_user", "app/data/mute_user", "app/ui/undo_unblock", "$bower_components/jquery-placeholder/jquery.placeholder.js"], function (module, require, exports) {
    ...
    module.exports = function (b) {
        ...
        shimConsole(d && !window.DEBUG.enabled), authToken.set(b.formAuthenticityToken), userInfo.set(b), ImpressionCookies.attachTo(document, {noTeardown: !0}), scribing(b), PromotedLogger.attachTo(document, {noTeardown: !0}), Scriber.attachTo(document), KeyboardShortcuts.attachTo(document, {
            routes: b.routes,
            noTeardown: !0
        }), b.deciders && b.deciders.dynamicLoadMediaForward && DynamicImageLoader.attachTo(document, {placeholder: ".js-media-img-placeholder"}), NavigationUI.attachTo(document, {
            ...
            viewContainer: b.viewContainer,
            noTeardown: !0
        }), Tooltips.attachTo(document, {noTeardown: !0}), $("input,textarea").placeholder(), $.browser.msie && parseInt($.browser.version, 10) == 10 && ScreenReaderLabel.attachTo(document, {noTeardown: !0}), MessageDrawer.attachTo("#message-drawer", {noTeardown: !0}), MuteUser.attachTo(document, {noTeardown: !0}), MuteUserData.attachTo(document, {noTeardown: !0}), UndoUnblockUser.attachTo(document, {noTeardown: !0}), ARIAEventLogger.attachTo(document, {noTeardown: !0}), b.loggedIn || LanguageDropdown.attachTo(".js-language-dropdown"), b.initialState && b.initialState.ttft_navigation && (ttftNavigationEnabled = !0), ttftNavigationEnabled && TTFTNavigation.attachTo(document, {
            pageName: b.pageName,
        ...
        var a = $.event, b = a.special, c = b.drag = {
            defaults: {
                ...
                return {
                    ...
                    droppable: [],
                    offset: $(a)[b.relative ? "position" : "offset"]() || {top: 0, left: 0}
                }
            }, handler: function (d) {
                var e = d.data;
                switch (d.type) {
    ...
    function withDialog() {
        compose.mixin(this, [withKeyboardModality, withScrollbarWidth]), this.defaultAttrs({
            ...
            var b = this.getWindow(), c = {
                top: Math.max(0, parseInt((b.height() - a.outerHeight()) / 2)),
                left: Math.max(0, parseInt((b.width() - a.outerWidth()) / 2))
            };
            return c
        }, this.getWindow = function () {
            return $(window)
        }, this.position = function () {
            var a = this.center(this.$dialog), b = this.getWindow(), c = b.height(), d = b.scrollTop();
            this.attr.top != null && (a.top = this.attr.top), this.attr.left != null && (a.left = this.attr.left), this.attr.maxTop != null && (a.top = Math.min(a.top, this.attr.maxTop)), this.attr.maxLeft != null && (a.left = Math.min(a.left, this.attr.maxLeft)), $("body").attr("dir") === "rtl" ? this.$dialog.css({
                ...
                top: a.top,
                left: a.left
            }), c < this.$dialog.outerHeight() ? (this.$dialog.css("position", "absolute"), this.$dialog.css("top", a.top + d)) : this.attr.fixed === !1 && this.$dialog.css("top", a.top + d)
            ...
            var a = this, b = {relative: !0, handle: this.attr.modalHeaderSelector}, c = function (a, b) {
                $("body").attr("dir") === "rtl" ? this.$dialog.css({
                    top: b.offsetY,
                    right: b.originalX - b.deltaX
                }) : this.$dialog.css({top: b.offsetY, left: b.offsetX})
            };
            ...
            this.trigger(this.$dialog, {type: "uiDialogInitialFocus", defaultBehavior: "setInitialFocus"})
            ...
            if (!this.isOpen())return;
            var b = {keydown: !0, uiShortcutEsc: !0}, c = a && b[a.type];
            this.trigger({type: "uiDialogCloseRequested", defaultBehavior: this.blurAndClose.bind(this, c)})
            ...
            a || (this.$dialog = this.$dialogContainer.find(this.attr.modalSelector)), this.on("click", {closeTargetsSelector: this.close}), this.on("keydown", {closeTargetsSelector: this.handleCloseKeys}), this.on(document, "uiShortcutEsc uiCloseDialog", this.close), this.on(document, "uiBeforePageChanged", this.closeImmediately), this.on(document, "uiDialogContentChanged", this.setFocusWhenContentChanges), this.on("focusin", {
                lastTabStopSelector: this.focusFirstAvailableControl,
                firstTabStopSelector: this.focusLastAvailableControl
            }), this.on("focusout", {hideFocusSelector: this.removeHideFocusClass}), this.attr.triggerSelector && this.on(this.attr.triggerSelector, "click", this.openWhenTriggerClicked), this.attr.closeOnOtherDialogOpened && this.on(document, "uiDialogOpened", this.closeOtherDialogs), !a && this.$dialogContainer.is(":visible") && (this.initiallyVisible = !0, this.open())
        })
    }
...
define("app/ui/signup_call_out", ["module", "require", "exports", "core/component"], function (module, require, exports) {
    function signupCallOut() {
        this.defaultAttrs({signupFormSubmitSelector: ".signup-btn, .SignupForm-submit"}), this.notifySignupButtonClicked = function () {
            this.trigger("uiSignupButtonClicked")
        }, this.after("initialize", function () {
            this.on("click", {signupFormSubmitSelector: this.notifySignupButtonClicked})
        })
    }
...
define("app/ui/front_page_photo_set", ["module", "require", "exports", "core/component", "core/clock"], function (module, require, exports) {
    function expPhotoSet() {
        this.defaultAttrs({
            ...
            if (this.$companionTweets.length <= 1)return;
...
define("app/utils/ttft", ["module", "require", "exports", "app/data/scribe_transport", "app/utils/params", "app/utils/time", "app/data/user_info", "app/utils/browser"], function (module, require, exports) {
    ...
    function scribePerftownEvents(a) {
        if (!userInfo.getDecider("web_perftown_ttft"))return;
        ...
        }, d = JSON.stringify({browser: browser($.browser)});
    ...
    window.ttft = {now: time.now, recordMilestone: recordMilestone}, scribeMilestones(!1), setTimeout(function () {
        scribeMilestones(!0)
    }, 45e3), module.exports = {startAjaxTracking: startAjaxTracking, _scribeTransport: scribeTransport}
});
    ...
    function b() {
        function e() {
            ...
            if (window.swiftActionQueue
                ...
                if (c.deciders)if (c.deciders.scribeReducedActionQueue)for (f in e.buckets)$(document).trigger("scribe", {
                    scribeEvent: {component: "reduced_action_queue", action: f}, scribeData: {
                        event_value: e.buckets[f].length
                    }
                }); else if (c.deciders.scribeActionQueue)for (f in e.buckets)$(document).trigger("scribe", {
                    scribeEvent: {
                        component: "action_queue",
                        action: f
                    }, scribeData: {event_value: e.buckets[f].length}
                });
                e.flush($);
        ...
        $(document).on("scribedata.ScribeTransport", function (a, b) {
            ...
            if (c = b.event_namespace) {
                var d = [c.client, c.page, c.section, c.component, c.element
                    , c.action].join(":");
                window.console && console.info("scribe", d)
            }
        })
    } else a.enable(!1);
